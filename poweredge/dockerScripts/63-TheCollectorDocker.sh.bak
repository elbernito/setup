...
sudo docker run -d --name elk --restart=always -e ES_HEAP_SIZE="4g" -e LS_HEAP_SIZE="1g" -v /workplace/elk/logs/elasticsearch:/var/log/elasticsearch -v /workplace/elk/logs/kibana:/var/log/kibana -v /workplace/elk/logs/logstash:/var/log/logstash -v /workplace/elk/logstash/config:/opt/logstash/config -v /workplace/elk/elasticsearch/data:/var/lib/elasticsearch -p 5601:5601 -p 9200:9200 -p 5044:5044 sebp/elk:7.16.3
